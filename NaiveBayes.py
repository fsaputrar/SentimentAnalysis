...
class Naive_Bayes:
    ...
    def MultinomialTrain(self):
        ...
        with open("C:\Users\ACER\PycharmProjects\ProgramBismillah\data\DataLatihBaru85%.csv", "r") as infile:
    ...
    def MultinomialTesting(self):
        ...
        mfitur = []
        with open("C:\Users\ACER\PycharmProjects\ProgramBismillah\data\DataUjiBaru85%.csv", "r") as infile:
            for fitur in infile.readlines():
                fitur = fitur.split(',')
                if (fitur[0] == 'F7') or (fitur[0] == 'F8') or (fitur[0] == 'F9') or (fitur[0] == 'F10') or (
                        fitur[0] == 'F13') or (fitur[0] == 'F14') or (fitur[0] == 'F15') or (fitur[0] == 'F16') or (
    ...
    def Posterior(self):
        ...
        with open("C:\Users\ACER\PycharmProjects\ProgramBismillah\data\datasetbakuuji.csv" , "r") as f:
            with open('C:\Users\ACER\PycharmProjects\ProgramBismillah\data\datauji85%.csv', 'wb') as f1:
...
fiturs = []
docs = []
with open("C:\Users\ACER\PycharmProjects\ProgramBismillah\data\DataLatihBaru85%.csv","rb") as f:
    fiturcsv = csv.reader(f)
    fiturs = [x for x in fiturcsv]
    fiturs.insert(0, fiturs[0])
    #fiturs.pop(0)

with open("C:\Users\ACER\PycharmProjects\ProgramBismillah\data\DataUjiBaru85%.csv", "rb") as fu:
    fiturujicsv = csv.reader(fu)
    fitursuji = [x for x in fiturujicsv]
    fitursuji.insert(0, fitursuji[0])
    #fitursuji.pop(0)

with open("C:\Users\ACER\PycharmProjects\ProgramBismillah\data\datasetbakulatih.csv", "rb") as f:
