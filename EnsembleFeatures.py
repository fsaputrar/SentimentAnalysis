...
class EnsemblesFeatures:
    ...
    def F11(self):
        with open("C:\Users\ACER\PycharmProjects\Skripsimaster\kamus\emoticon_id.txt", "rb") as f:
    ...
    def F13(self):
        with open("C:\Users\ACER\PycharmProjects\Skripsimaster\Postag\Noun.csv",
                  "rb") as n:
    ...
    def F14(self):
        with open("C:\Users\ACER\PycharmProjects\Skripsimaster\Postag\Adjective.csv",
                  "rb") as adjv:
    ...
    def F15(self):
        with open("C:\Users\ACER\PycharmProjects\Skripsimaster\Postag\Verb.csv",
                  "rb") as v:
    ...
    def F16(self):
        with open("C:\Users\ACER\PycharmProjects\Skripsimaster\Postag\Adverb.csv",
                  "rb") as adv:
    ...
    def F17(self):
        with open("C:\Users\ACER\PycharmProjects\Skripsimaster\Postag\Interjection.csv",
                  "rb") as i:
    ...
    def F23(self):
        with open("C:\Users\ACER\PycharmProjects\Skripsimaster\kamus\sentiwords_id.txt", "rb") as f:
    ...
    def F24(self):
        with open("C:\Users\ACER\PycharmProjects\Skripsimaster\kamus\sentiwords_id.txt",
                  "rb") as f:
            wordsReader = csv.reader(f, delimiter=":")
            words = []
            for word in wordsReader:
    ...
    def F37(self):
        with open('C:\Users\ACER\PycharmProjects\Skripsimaster\kamus\penegasan_boosterwords_id.txt',
                  'rb') as f:
            wordsReader = csv.reader(f, delimiter=":")
            words = []
            for word in wordsReader:
