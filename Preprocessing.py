...
class Preprocess:
    ...
    def preprocessing(self):
        ...
        # stopword
        stopword = open('C:\Users\ACER\PycharmProjects\ProgramBismillah\kamus\modifikasi_stopword.txt', 'r').read()
        ...
        for terms in termfeature:  # takes each term in the set
            ...
            with open("C:\Users\ACER\PycharmProjects\ProgramBismillah\output\ekstrakfiturbaku.csv", "ab") as fp:
                wr = csv.writer(fp)
                wr.writerow(rawterm)
docs = []
with open("C:\Users\ACER\PycharmProjects\ProgramBismillah\data\datasetbaku.csv","r") as data:
    x = csv.reader(data)
    docs = []
    for i in x:
        docs.append(i)
